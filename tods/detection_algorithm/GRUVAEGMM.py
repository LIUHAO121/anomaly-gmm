...
from tensorflow.keras.layers import Dense, Dropout , LSTM, Lambda,Input,GRU
...
class GRUVAEGMMPrimitive(UnsupervisedOutlierDetectorBase[Inputs, Outputs, Params, Hyperparams]):
    """
    ...
    def __init__(self, *,
        ...
        self._clf = GRUVAEGMM(hidden_size=hyperparams['hidden_size'],
...
class GRUVAEGMM(BaseDetector):
    ...
    def __init__(self, hidden_size : int = 64,
        ...
        super(GRUVAEGMM, self).__init__(contamination=contamination)
    ...
    def _build_model(self):
        ...
        layer = GRU(self.hidden_size,return_sequences=True,dropout = self.dropout_rate)(inputs)
