...
class LSTMAEGMMPrimitive(UnsupervisedOutlierDetectorBase[Inputs, Outputs, Params, Hyperparams]):
    """
    ...
    def __init__(self, *,
        ...
        self._clf = LstmAEGMM(hidden_size=hyperparams['hidden_size'],
...
class LstmAEGMM(BaseDetector):
    ...
    def __init__(self, hidden_size : int = 64,
        ...
        super(LstmAEGMM, self).__init__(contamination=contamination)
