...
class LSTMAEPrimitive(UnsupervisedOutlierDetectorBase[Inputs, Outputs, Params, Hyperparams]):
    """
    ...
    metadata = metadata_base.PrimitiveMetadata({
        ...
        'hyperparams_to_tune': ['hidden_neurons','hidden_size','hidden_activation', 'loss', 'optimizer', 'epochs', 'batch_size',
    ...
    def __init__(self, *,
        ...
        self._clf = LstmAE(hidden_size=hyperparams['hidden_size'],
...
class LstmAE(BaseDetector):
    ...
    def __init__(self, hidden_size : int = 64,
                 ...
                 l2_regularizer : float =0.1, validation_size : float =0.1,hidden_neurons : list=[20,5,20],hidden_activation : str='relu',
                 window_size: int = 1, stacked_layers: int  = 1, verbose : int = 1, contamination:int = 0.001):

        super(LstmAE, self).__init__(contamination=contamination)
